...
export function Prose({
  ...
  return (
    <div
      className={cn(
        "w-full max-w-[68ch] text-base leading-[1.7] text-[color:var(--color-ink)]",
        "[&_p]:mb-6",
        "[&_h1]:mt-12 [&_h1]:mb-6 [&_h1]:font-serif [&_h1]:text-5xl [&_h1]:font-black [&_h1]:tracking-tight",
        "[&_h2]:mt-12 [&_h2]:mb-5 [&_h2]:font-serif [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:tracking-tight",
        "[&_h3]:mt-10 [&_h3]:mb-4 [&_h3]:font-serif [&_h3]:text-2xl [&_h3]:font-bold",
        "[&_h4]:mt-8 [&_h4]:mb-3 [&_h4]:font-serif [&_h4]:text-xl [&_h4]:font-bold",
